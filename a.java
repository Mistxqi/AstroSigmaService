...
class SortByQty implements Comparator<Products>{
    public int compare(Products a, Products b){
    ...
    public BundleBuy createBundle(){
        ...
        switch (choice) {
            case 1 :
                ...
                break;
            case 2 : 
                Collections.sort(allProducts, new SortByName());
                break;
            case 3 :
                Collections.sort(allProducts, new SortByQty());
                break;
            default:
                System.out.println("Invalid: Sorting Alphabetically.");
                Collections.sort(allProducts, new SortByName());
                break;
        }
